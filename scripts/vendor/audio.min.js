(function (f, k, g) {
  var n = (function () {
    for (
      ...
      if (a.test(e)) return (a = e.split("/")), a.pop(), a.join("/") + "/";
    }
    return "";
  })();
  g[f] = {
    ...
    settings: {
      ...
      retinaImageLocation: n + "player-graphics@2x.gif",
      ...
      loadError: function (a) {
        ...
        var b = h(a.errorMessageClass, this.wrapper);
        g[f].helpers.removeClass(this.wrapper, a.loadingClass);
        g[f].helpers.addClass(this.wrapper, a.errorClass);
        b.innerHTML = 'Error loading: "' + this.mp3 + '"';
      },
      init: function () {
        g[f].helpers.addClass(
          this.wrapper,
      ...
      loadProgress: function (a) {
        h(this.settings.createPlayer.loaderClass, this.wrapper).style.width =
          Math.round(100 * a) + "%";
      },
      playPause: function () {
      ...
      play: function () {
        ...
        g[f].helpers.addClass(this.wrapper, a.playingClass);
      },
      pause: function () {
        g[f].helpers.removeClass(
          this.wrapper,
      ...
      updatePlayhead: function (a) {
        ...
        h(b.progressClass, this.wrapper).style.width =
          Math.round(100 * a) + "%";
        var b = h(b.playedClass, this.wrapper),
          c = this.duration * a;
        a = Math.floor(c / 60);
        c = Math.floor(c % 60);
    ...
    createAll: function (a, b) {
      var c = b || document.getElementsByTagName("audio"),
        d = [];
      a = a || {};
      for (var e = 0, p = c.length; e < p; e++)
        -1 <
          (" " + c[e].parentNode.className + " ")
            .replace(/[\n\t]/g, " ")
            .indexOf(" audiojs ") || d.push(this.newInstance(c[e], a));
      return d;
    },
    newInstance: function (a, b) {
      ...
      c.createPlayer.markup
        ? (a = this.createPlayer(a, c.createPlayer, e))
        : a.parentNode.setAttribute("id", e);
      e = new g[k](a, c);
      c.css && this.helpers.injectCss(e, c.css);
      c.useFlash && c.hasFlash
        ? (this.injectFlash(e, d), this.attachFlashEvents(e.wrapper, e))
        : c.useFlash && !c.hasFlash && c.flashError.apply(e);
      (!c.useFlash || (c.useFlash && c.hasFlash)) &&
    ...
    createPlayer: function (a, b, c) {
      ...
      d.setAttribute("id", c);
      e.outerHTML && !document.createElement("audio").canPlayType
    ...
    attachEvents: function (a, b) {
      if (b.settings.createPlayer) {
        ...
        g[f].events.addListener(d, "click", function (a) {
          b.playPause.apply(b);
        });
        g[f].events.addListener(e, "click", function (a) {
          a = a.clientX - this.getBoundingClientRect().left;
          b.skipTo(a / e.offsetWidth);
        });
        b.settings.useFlash ||
          (g[f].events.trackLoadProgress(b),
          g[f].events.addListener(b.element, "timeupdate", function (a) {
            b.updatePlayhead.apply(b);
          }),
          g[f].events.addListener(b.element, "ended", function (a) {
            b.trackEnded.apply(b);
          }),
          g[f].events.addListener(b.source, "error", function (a) {
    ...
    attachFlashEvents: function (a, b) {
      ...
      b.skipTo = function (a) {
        a > b.loadedPercent ||
          (b.updatePlayhead.call(b, [a]), b.element.skipTo(a));
      };
      ...
      b.play = function () {
        b.settings.preload ||
          ((b.settings.preload = !0), b.element.init(b.mp3));
        b.playing = !0;
        b.element.pplay();
    ...
    helpers: {
      ...
      injectCss: function (a, b) {
        ...
        d &&
          ...
          g ? d.insertBefore(f, g) : d.appendChild(f));
      },
    ...
    events: {
      ...
      trackLoadProgress: function (a) {
        if (a.settings.preload) {
          var b,
            c,
            d = /(ipod|iphone|ipad)/i.test(navigator.userAgent);
          b = setInterval(function () {
            -1 < a.element.readyState && (d || a.init.apply(a));
            1 < a.element.readyState &&
      ...
      ready: (function () {
        return function (a) {
          var b = window,
            ...
            m = e.addEventListener ? "" : "on",
            l = function (d) {
              if ("readystatechange" != d.type || "complete" == e.readyState)
                ("load" == d.type ? b : e)[h](m + d.type, l, !1),
          ...
          if ("complete" == e.readyState) a.call(b, "lazy");
            ...
            e[g](m + "DOMContentLoaded", l, !1);
            e[g](m + "readystatechange", l, !1);
            b[g](m + "load", l, !1);
          }
        };
      })(),
  ...
  g[k].prototype = {
    ...
    skipTo: function (a) {
      a > this.loadedPercent ||
        ((this.element.currentTime = this.duration * a), this.updatePlayhead());
    },
    load: function (a) {
      this.loadStartedCalled = !1;
  ...
  var h = function (a, b) {
    var c = [];
    b = b || document;
    if (b.getElementsByClassName) c = b.getElementsByClassName(a);
    else {
      var d,
        e,
        ...
        g = new RegExp("(^|\\s)" + a + "(\\s|$)");
      d = 0;
      for (e = f.length; d < e; d++) g.test(f[d].className) && c.push(f[d]);
    }
